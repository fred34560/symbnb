...
class Booking
{
    ...
    /**
     * Permet de retourner un tables des jours qui correcondent à ma réservation
     *
     * @return array Un tableau d'objet DateTime représentant les jours de ma réservation
     */
